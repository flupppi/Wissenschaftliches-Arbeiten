...
\chapter{Algorithmen zur Pfadplanung}%TODO erwähnen, dass wir uns auf die Robot Definition aus dem Buch beziehen.
...
%\newline
%Ein Ansatzpunkt wäre ein \on-line algorithmus" der sich aktiv aktualisiert, aber auch dieser kann nicht die gesamte komplexität wiederspiegeln. 
...
\section{Klassifizierung von Pfadplanungsalgorithmen} \label{Kapitel 3.2} % Hier bitte noch ein Bild, das die Unterschiede der einzelnen Klassen sichtbar macht. 
...
\section{Diskrete Pfadplanung} \label{Kapitel 3.3} % In diesem Kapitel hätte ich gerne noch ein Bild, das das Konzept der diskreten Pfadplanung auf einen Blick veranschaulicht veranschaulicht
